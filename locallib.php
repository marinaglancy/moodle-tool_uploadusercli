...
class tool_uploadusercli_uu_progress_tracker {
    ...
    public function __construct() {
        $this->headers = [
            ...
            'line' => get_string('uucsvline', 'tool_uploadusercli'),
            'id' => 'ID',
    ...
    public function start() {
        $ci = 0;
        echo '<table id="uuresults" class="generaltable boxaligncenter flexible-wrap" summary="'.get_string('uploadusersresult', 'tool_uploadusercli').'">';
