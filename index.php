...
if (empty($iid)) {
    ...
    if ($formdata = $mform1->get_data()) {
        ...
        echo $OUTPUT->heading_with_help(get_string('uploadusers', 'tool_uploadusercli'), 'uploadusers', 'tool_uploadusercli');
...
// Test if columns ok.
$process = new \tool_uploadusercli\process($cir);
...
if ($formdata = $mform2->is_cancelled()) {
    ...
    // Print the header.
    echo $OUTPUT->header();
    echo $OUTPUT->heading(get_string('uploadusersresult', 'tool_uploadusercli'));
...
echo $OUTPUT->heading(get_string('uploaduserspreview', 'tool_uploadusercli'));
...
// Preview table data.
$table = new \tool_uploadusercli\preview($cir, $filecolumns, $previewrows);
