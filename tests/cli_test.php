...
/**
 * Tests for CLI tool_uploadusercli.
 *
...
use \tool_uploadusercli\cli_helper;
...
class tool_uploadusercli_cli_testcase extends advanced_testcase {
     ...
     * @return \tool_uploadusercli\cli_helper
     */
    protected function construct_helper(array $mockargv = []) {
        ...
        $clihelper = new cli_helper(\tool_uploadusercli\local\text_progress_tracker::class);
