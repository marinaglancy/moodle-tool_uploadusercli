...
/**
 * Tests for field value validators of tool_uploadusercli.
 *
...
class field_value_validators_testcase extends advanced_testcase {
    ...
    public function themes_provider() {
        return [
            'User themes disabled' => [
                false, 'boost', 'warning', get_string('userthemesnotallowed', 'tool_uploadusercli')
            ],
            'User themes enabled, empty theme' => [
                true, '', 'warning', get_string('notheme', 'tool_uploadusercli')
            ],
            'User themes enabled, invalid theme' => [
                true, 'badtheme', 'warning', get_string('invalidtheme', 'tool_uploadusercli', 'badtheme')
            ],
    ...
    /**
     * Unit test for \tool_uploadusercli\local\field_value_validators::validate_theme()
     *
